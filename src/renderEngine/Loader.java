...
public class Loader
{
	...
	private void storeDataInAttribList(int attributeNumber, int coordsSize, float[] data)
	{
	...
	private void bindIndicesBuffer(int[] indices)
	{
		...
		IntBuffer buffer = stroreDataInIntBuffer(indices);
		
		GL15.glBufferData(GL15.GL_ELEMENT_ARRAY_BUFFER, buffer, GL15.GL_STATIC_DRAW);
	}
	
	private IntBuffer stroreDataInIntBuffer(int[] data)
	{
